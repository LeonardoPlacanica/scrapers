...
const pagineGialleSearchBaseUrl = 'https://www.paginegialle.it/ricerca';

// Business-facing categories likely to benefit from cold outbound to win clients.
const targetCategories: string[] = [
  ...
  'Agenzia grafica',
  'Agenzia hostess e promoter',
  'Agenzie e uffici commerciali',
  ...
  'Adesivi',
  'Antifurti',
  'Ascensori installazione e manutenzione',
  'Automazione e robotica',
  'Aziende elettromeccaniche',
...
const main = async () => {
  for (const category of targetCategories) {
    const searchUrl = `${pagineGialleSearchBaseUrl}/${encodeURIComponent(category)}`;
    await scrapePagineGialle(searchUrl).catch((error) => {
